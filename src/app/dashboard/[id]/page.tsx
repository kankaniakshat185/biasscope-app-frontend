          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card 
                ...
                className={`rounded-none shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] border-2 border-black cursor-pointer transition-all ${filterBias === 'LEFT' ? 'ring-4 ring-blue-500 bg-blue-50 dark:bg-blue-900/30' : 'bg-white hover:bg-blue-50 dark:bg-blue-900/10'}`}
              >
                <CardHeader className="border-b-2 border-black bg-blue-100/50">
                ...
                <CardContent className="pt-6 relative">
                  <span className="text-6xl text-blue-200 absolute -top-2 left-2 font-serif font-black opacity-50 select-none">"</span>
                  <p className="text-base leading-relaxed text-blue-900 relative z-10 pl-6 italic font-medium">{renderWithBoldCitations(insights.leftWingSummary)}</p>
                </CardContent>
              </Card>
              <Card 
                onClick={() => setFilterBias(filterBias === "RIGHT" ? null : "RIGHT")}
                className={`rounded-none shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] border-2 border-black cursor-pointer transition-all ${filterBias === 'RIGHT' ? 'ring-4 ring-red-500 bg-red-50 dark:bg-red-900/30' : 'bg-white hover:bg-red-50 dark:bg-red-900/10'}`}
              >
                <CardHeader className="border-b-2 border-black bg-red-100/50">
                ...
                <CardContent className="pt-6 relative">
                  <span className="text-6xl text-red-200 absolute -top-2 left-2 font-serif font-black opacity-50 select-none">"</span>
                  <p className="text-base leading-relaxed text-red-900 relative z-10 pl-6 italic font-medium">{renderWithBoldCitations(insights.rightWingSummary)}</p>
                </CardContent>
              </Card>
            </div>
          </div>
