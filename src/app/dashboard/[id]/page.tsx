    ...
    <div className="font-[family-name:var(--font-geist-sans)] min-h-screen text-slate-900 dark:text-slate-100 flex flex-col">
      ...
      <div className="max-w-7xl mx-auto space-y-8 w-full p-8 flex-1">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              {Object.entries(insights.entitySentiment).map(([entity, data]: [string, any]) => (
                <Card key={entity} className="rounded-none border-2 border-black hover:-translate-y-1 transition-transform shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div id="bias-visuals" className="grid grid-cols-1 lg:grid-cols-3 gap-6 scroll-mt-32">
          <Card className="rounded-none col-span-1 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] border-2 border-black">
            <CardHeader className="border-b-2 border-black">
